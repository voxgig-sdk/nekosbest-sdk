...
func (sdk *NekosbestSDK) OptionsMap() map[string]any {
...
func (sdk *NekosbestSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NekosbestSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NekosbestSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NekosbestSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NekosbestSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NekosbestSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NekosbestSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NekosbestSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NekosbestSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NekosbestSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
