...
Learn more about nekos.best API at [docs.nekos.best](https://docs.nekos.best/).
...
This SDK exposes the API as a small set of **semantic entities** — GetRandomByCategory, Image and Search — that you
...
| --- | --- | --- |
| **GetRandomByCategory** | The GetRandomByCategory entity (list). | `/{category}` |
| **Image** | The Image entity (list, load). | `/endpoints` |
