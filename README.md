...
This is an unofficial SDK for the nekos.best public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nekosbest` | `npm install @voxgig-sdk/nekosbest` |
| Python | `voxgig-sdk-nekosbest` | `pip install voxgig-sdk-nekosbest` |
| PHP | `voxgig-sdk/nekosbest` | `composer require voxgig-sdk/nekosbest` |
| Golang | `github.com/voxgig-sdk/nekosbest-sdk/go` | `go get github.com/voxgig-sdk/nekosbest-sdk/go` |
| Ruby | `voxgig-sdk-nekosbest` | `gem install voxgig-sdk-nekosbest` |
| Lua | `voxgig-sdk-nekosbest` | `luarocks install voxgig-sdk-nekosbest` |
