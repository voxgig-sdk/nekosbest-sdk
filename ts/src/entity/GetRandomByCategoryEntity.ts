...
class GetRandomByCategoryEntity extends NekosbestEntityBase<GetRandomByCategory> {
  ...
  constructor(client: NekosbestSDK, entopts: any) {
    ...
    this.name = 'get_random_by_category'
    this.name_ = 'get_random_by_category'
    this.Name = 'GetRandomByCategory'
  }


  make(this: GetRandomByCategoryEntity) {
    return new GetRandomByCategoryEntity(this._client, this.entopts())
  }
