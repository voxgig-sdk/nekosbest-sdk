# Nekosbest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NekosbestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NekosbestSDK(...) and NekosbestSDK.test(...) become
#      NekosbestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nekosbest_sdk"
_SDK_CLASS = "NekosbestSDK"
...
_ENTITIES = {
    "GetRandomByCategory": "get_random_by_category",
    "Image": "image",
    "Search": "search",
}
