...
from nekosbest_sdk.nekosbest_types import (
    GetRandomByCategory,
...
class GetRandomByCategoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomByCategoryEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomByCategory:
    ...
    def match_get(self) -> GetRandomByCategory:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetRandomByCategory]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetRandomByCategory().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
