...
from nekosbest_sdk.core.control import NekosbestControl
...
from nekosbest_sdk.core.helpers import get_ctx_prop, to_map
...
class NekosbestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, NekosbestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NekosbestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NekosbestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NekosbestError(code, msg, self)
