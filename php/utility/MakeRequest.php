...
// Nekosbest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NekosbestMakeRequest
{
    public static function call(NekosbestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NekosbestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NekosbestResponse($fetched);
        } else {
