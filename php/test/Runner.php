...
class NekosbestTestRunner
{
    ...
    {
        $live = self::getenv('NEKOSBEST_TEST_LIVE');
        $override = self::getenv('NEKOSBEST_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEKOSBEST_TEST_EXPLAIN');
...
class_alias('NekosbestTestRunner', 'Runner');
class_alias('NekosbestHelpers', 'Helpers');
