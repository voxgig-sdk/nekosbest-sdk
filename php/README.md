...
The PHP SDK for the Nekosbest API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetRandomByCategory(null)->list(null, null);
...
[$result, $err] = $client->Nekosbest(null)->load(
    ["id" => "test01"], null
);
