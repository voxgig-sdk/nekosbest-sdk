...
The PHP SDK for the Nekosbest API — an entity-oriented client using PHP conventions.
...
```
php/
├── nekosbest_sdk.php          -- Main SDK class
...
The main class (`nekosbest_sdk.php`) exports the SDK class
