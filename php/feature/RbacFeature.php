...
class NekosbestRbacFeature extends NekosbestBaseFeature
{
    ...
    private function _required(NekosbestContext $ctx): ?string
    {
    ...
    private function _reject(NekosbestContext $ctx, string $required): void
    {
    ...
    private function _track(NekosbestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
