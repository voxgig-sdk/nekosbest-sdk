...
// Nekosbest SDK clienttrack feature
...
class NekosbestClienttrackFeature extends NekosbestBaseFeature
{
    ...
    public function PostConstruct(NekosbestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Nekosbest-SDK';
