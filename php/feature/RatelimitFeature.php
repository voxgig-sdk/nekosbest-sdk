...
// Nekosbest SDK ratelimit feature
...
class NekosbestRatelimitFeature extends NekosbestBaseFeature
{
    ...
    private function _acquire(NekosbestContext $ctx): void
    {
    ...
    private function _track(NekosbestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
