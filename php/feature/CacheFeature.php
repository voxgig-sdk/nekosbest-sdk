...
class NekosbestCacheFeature extends NekosbestBaseFeature
{
    ...
    private function _through(NekosbestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
