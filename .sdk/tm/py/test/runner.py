...
class NekosbestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NekosbestTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NekosbestTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NekosbestTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
