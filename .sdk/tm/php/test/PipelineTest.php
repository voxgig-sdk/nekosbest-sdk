...
{
    private static function utility(): NekosbestUtility
    {
        return new NekosbestUtility();
    }
    ...
    private static function ctx(array $over = []): NekosbestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NekosbestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NekosbestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NekosbestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NekosbestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NekosbestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NekosbestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NekosbestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NekosbestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NekosbestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NekosbestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NekosbestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NekosbestResponse([]),
            'result' => new NekosbestResult([]),
        ]);
        [, $err] = NekosbestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NekosbestSpec([]),
            'response' => null,
            'result' => new NekosbestResult([]),
        ]);
        [, $err] = NekosbestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NekosbestSpec(['step' => 's']),
            'response' => new NekosbestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NekosbestResult([]),
        ]);
        [, $err] = NekosbestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NekosbestSpec(['step' => 's']),
            'response' => new NekosbestResponse(self::resp(200, ['v' => 1])),
            'result' => new NekosbestResult([]),
        ]);
        [, $err] = NekosbestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NekosbestSpec(['step' => 's']),
            'response' => new NekosbestResponse(self::resp(200, ['v' => 2])),
            'result' => new NekosbestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NekosbestMakeResponse::call($ctx);
    ...
    {
        $preset = new NekosbestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NekosbestSpec([]),
            'response' => new NekosbestResponse([]),
            'result' => new NekosbestResult([]),
        ...
        [$got, $err] = NekosbestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NekosbestResult([])]);
        [, $err] = NekosbestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NekosbestSpec([]), 'result' => null]);
        [, $err] = NekosbestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NekosbestSpec(['step' => 's']),
            'result' => new NekosbestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NekosbestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NekosbestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NekosbestSpec(['step' => 's']),
            'result' => new NekosbestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NekosbestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NekosbestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NekosbestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NekosbestSpec([]),
            'result' => new NekosbestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NekosbestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NekosbestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NekosbestError('boom', 'boom');
        $utility->fetcher = function (NekosbestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NekosbestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NekosbestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NekosbestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NekosbestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NekosbestResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NekosbestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NekosbestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NekosbestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NekosbestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NekosbestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NekosbestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NekosbestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NekosbestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NekosbestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NekosbestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NekosbestResult(['ok' => false])]);
        $this->expectException(NekosbestError::class);
        NekosbestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NekosbestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NekosbestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NekosbestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NekosbestBaseFeature();
        $b = new NekosbestBaseFeature();
        NekosbestFeatureAdd::call($ctx, $a);
        NekosbestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NekosbestBaseFeature
    {
        $f = new NekosbestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NekosbestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NekosbestContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NekosbestSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NekosbestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NekosbestResponse(['headers' => null]),
            'result' => new NekosbestResult([]),
        ]);
        NekosbestResultHeaders::call($ctx);
