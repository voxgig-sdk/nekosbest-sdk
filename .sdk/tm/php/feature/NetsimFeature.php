...
class NekosbestNetsimFeature extends NekosbestBaseFeature
{
    ...
    private function _simulate(NekosbestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NekosbestContext $ctx, array $applied): void
    {
        $client = $this->client;
