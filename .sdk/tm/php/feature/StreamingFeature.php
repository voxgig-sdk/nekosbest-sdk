...
// Nekosbest SDK streaming feature
...
class NekosbestStreamingFeature extends NekosbestBaseFeature
{
    ...
    private function _iterate(NekosbestResult $result): \Generator
    {
    ...
    private function _streamable(NekosbestContext $ctx): bool
    {
