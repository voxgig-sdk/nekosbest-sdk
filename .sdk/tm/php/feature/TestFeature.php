...
// Nekosbest SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NekosbestTestFeature extends NekosbestBaseFeature
{
    ...
    public function init(NekosbestContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NekosbestContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NekosbestParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NekosbestContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NekosbestContext $ctx, $op, $args): array
    {
