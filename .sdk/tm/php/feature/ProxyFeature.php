...
class NekosbestProxyFeature extends NekosbestBaseFeature
{
    ...
    public function init(NekosbestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NekosbestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
