...
class NekosbestTimeoutFeature extends NekosbestBaseFeature
{
    ...
    private function _with_timeout(NekosbestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NekosbestContext $_ctx, float $ms): void
    {
        $client = $this->client;
