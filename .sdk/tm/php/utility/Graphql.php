...
class NekosbestGraphql
{
    ...
    // equivalent.
    public static function body(NekosbestContext $ctx): mixed
    {
    ...
    public static function errors(NekosbestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
