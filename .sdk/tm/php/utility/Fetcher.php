...
// Nekosbest SDK utility: fetcher

class NekosbestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NekosbestSDK/1.0)';
    ...
    public static function call(NekosbestContext $ctx, string $fullurl, array $fetchdef): array
    {
