...
func registerSDKWords(r *eng.Registry, client *sdk.NekosbestSDK) {
...
func runOp(client *sdk.NekosbestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
