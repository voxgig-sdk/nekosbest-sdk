...
local NekosbestSDK = {}
NekosbestSDK.__index = NekosbestSDK
...
NekosbestSDK._make_feature = _make_feature


function NekosbestSDK.new(options)
  local self = setmetatable({}, NekosbestSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function NekosbestSDK:options_map()
...
function NekosbestSDK:get_utility()
  return Utility.copy(self._utility)
end


function NekosbestSDK:get_root_ctx()
  return self._rootctx
end


function NekosbestSDK:prepare(fetchargs)
...
function NekosbestSDK:direct(fetchargs)
...
-- by passing it.
function NekosbestSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function NekosbestSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "NekosbestSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function NekosbestSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = NekosbestSDK.new(sdkopts)
  sdk.mode = "test"
