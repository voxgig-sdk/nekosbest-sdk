...
local GetRandomByCategoryEntity = {}
GetRandomByCategoryEntity.__index = GetRandomByCategoryEntity


function GetRandomByCategoryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomByCategoryEntity)
  self._name = "get_random_by_category"
  self._client = client
...
function GetRandomByCategoryEntity:get_name()
  return self._name
end


function GetRandomByCategoryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomByCategoryEntity.new(self._client, opts)
end
...
function GetRandomByCategoryEntity:mark_deleted()
  self._deleted = true
end


function GetRandomByCategoryEntity:deleted()
  return true == self._deleted
end


function GetRandomByCategoryEntity:data_set(args)
  if args ~= nil then
...
function GetRandomByCategoryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomByCategoryEntity:match_set(args)
  if args ~= nil then
...
function GetRandomByCategoryEntity:match_get()
...
function GetRandomByCategoryEntity:stream(action, args, callopts)
...
function GetRandomByCategoryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetRandomByCategoryEntity
