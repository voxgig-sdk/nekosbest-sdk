...
class ImageEntity
  ...
  # @return [Image, Hash] the loaded Image; raises NekosbestError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = NekosbestHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Image>, Array] the matching Image items; raises NekosbestError on failure
