...
module NekosbestTestRunner
  ...
  def self.env_override(m)
    live = getenv("NEKOSBEST_TEST_LIVE")
    override = getenv("NEKOSBEST_TEST_OVERRIDE")
    ...
    explain = getenv("NEKOSBEST_TEST_EXPLAIN")
    m["NEKOSBEST_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NekosbestTestRunner
Helpers = NekosbestHelpers
Vs = VoxgigStruct
